...
export default function Home() {
  ...
  return (
    <Layout>
      <Seo title="サービス" description="サイト制作 運用など 僕がお手伝いできることをこちらに掲載します。" siteType="article" />
