...
export default function Home() {
  ...
  return (
    <Layout>
      <Seo title={pageTitle} description="当サイトにおける閲覧者の個人情報保護方針について記載しています。" siteType="article" pageUrl={url.pathname} />
      <div className="article-container pt-5 bg-white px-3 px-sm-4 mx-3 mx-md-auto">
        <article className="pb-5">
          <div className="mt-5 pb-5 lh-lg article-inner">
            ...
            <h2 className="h4 mt-5">問い合わせ情報について</h2>
            ...
            <h2 className="h4 mt-5">Cookieについて</h2>
            ...
            <h2 className="h4 mt-5">アクセス解析ツールについて</h2>
            ...
            <h2 className="h4 mt-5">第三者配信の広告サービスについて</h2>
            ...
            <h2 className="h4 mt-5">プライバシーポリシーの変更について</h2>
