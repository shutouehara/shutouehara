    ...
    <Layout>
      ...
      <article className="row row-cols-1 row-cols-sm-2 mt-3 mt-lg-4 pb-5 mx-0">
        ...
        <div className="profile-right mt-5 mt-md-0 col row row-cols-2 lh-lg">
          ...
          <div className="col-9 text-start ps-0 lh-lg">2019年より大阪の制作会社にて広告広報制作のアシスタントディレクターとして勤めてました。販促物やノベルティ制作、取扱説明書などの制作に携わりました。そこでウェブマーケティングを含む案件に関わったことから、ウェブ業界に興味を持ちました。<br />
