...
export default function Home({ data }) {
  ...
  return (
    <Layout>
      ...
      <div className="p-3 p-sm-5 m-auto" style={{maxWidth:'1200px'}}>
        <h2 className="mt-5 mb-4 pb-2 border-bottom border-dark text-center h5">このようなお困り、ありませんか？</h2>
        <Carousel activeIndex={index} onSelect={handleSelect} className="my-5 m-auto" style={{maxWidth:'960px'}}>
        ...
        <ul className="ps-0">
          ...
          <li className="mb-3 list-unstyled">
            <h2 className="fw-bold mt-5 mb-4 pb-2 border-bottom border-dark">サイト制作</h2>
          ...
          <li className="mb-3 list-unstyled">
            <h2 className="fw-bold mt-5 mb-4 pb-2 border-bottom border-dark">ウェブマーケティング</h2>
          ...
          <li className="mb-3 list-unstyled">
            <h2 className="fw-bold mt-5 mb-4 pb-2 border-bottom border-dark">既存WordPressカスタマイズ</h2>
          ...
          <li className="mb-3 list-unstyled display-none">
            <h2 className="fw-bold mt-5 mb-4 pb-2 border-bottom border-dark">画像編集/動画編集</h2>
            <ul className="ul-list gap">
